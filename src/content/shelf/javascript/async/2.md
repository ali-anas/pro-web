...
overview: Fulfills when all promises settle.
---
...
## Usage example our of promiseAllSettled function

  - using promiseAllSettled with all resolved promises
  ...
  - using promiseAllSettled with rejected promise
  ```js
