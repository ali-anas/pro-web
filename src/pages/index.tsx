            ...
            <div className="col col--8">
              <div className="w-full h-full flex flex-col justify-center">
                ...
                <Link
                  ...
                  to='https://drive.google.com/file/d/1S4gk0TUntahm2L_HdjfzGmsTpUUONjVT/view?usp=sharing'>
                  <><span>Resume</span>
    ...
    links: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: 'Resume',
            href: 'https://drive.google.com/file/d/1S4gk0TUntahm2L_HdjfzGmsTpUUONjVT/view?usp=sharing',
          },
          {
            label: 'Instagram',
