...
import {
  HeaderWrapper,
  FooterWrapper,
} from "../Layouts/SectionWrapper/SectionWrapper";
      ...
      <HeaderWrapper>
        <div className="container">
            ...
            <div className="w-full flex flex-wrap-reverse">
              <div className="col col--8">
                <div className="w-full h-full flex flex-col justify-center">
                  <h1
                    className={`text-5xl md:text-6xl lg:text-8xl bg-clip-text bg-gradient-to-r from-lime-500 via-emerald-500 to-cyan-lime-500 `}
                  >
                    {siteConfig.title}
                  </h1>
                  ...
                  <div className="w-full flex flex-nowrap flex-col md:flex-row justify-center md:justify-start items-center">
                    ...
                    <div className={styles.buttons}>
                      <Link
                        ...
                        to="https://drive.google.com/file/d/1TzratXkW5YCJBKkk7Mm5Q9ni66RxMPED/view?usp=sharing"
                      >
                        <>
                          <span>Resume</span>
                          <svg
          ...
          <div className="row relative flex justify-center items-center w-full">
            <span
              className={clsx(
                "inline-block absolute top-8 rounded-full cursor-pointer w-16 h-16 flex justify-center items-center",
                styles.btmArrow,
              )}
              onClick={() => handleScroll(bodySectionRef)}
            >
              <svg
  ...
  links: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Resume",
          href: "https://drive.google.com/file/d/1LYLt-l9Q5uQckpJ91AxxNNi-me1gZXoJ/view?usp=sharing",
        },
        {
          label: "Instagram",
          ...
          <div className="row">
            {footer.links.map((list, idx1) => (
              <div className="col col--3" key={`list-${idx1 + 1}`}>
                <div className="font-semibold mb-4">{list.title}</div>
