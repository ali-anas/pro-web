...
- Insert a dummy promise that will be rejected after a certain time. So if our api doesn't resolves before time, then our timeout promise will get fullfilled.
...
:::info
You can read more about Promise.ract() on mdn docs [here](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Promise/race)
:::
